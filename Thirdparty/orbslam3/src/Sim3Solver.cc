...
Sim3Solver::Sim3Solver(std::shared_ptr<KeyFrame> const& pKF1, std::shared_ptr<KeyFrame> const& pKF2, const vector<std::shared_ptr<MapPoint>> &vpMatched12, const bool bFixScale,
