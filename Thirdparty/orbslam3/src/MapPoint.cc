...
void MapPoint::SetBadFlag()
{
    ...
    mpMap->EraseMapPoint(shared_from_this()); //TODO: check
}
...
void MapPoint::Replace(std::shared_ptr<MapPoint> pMP)
{
    ...
    for(map<std::shared_ptr<KeyFrame>,tuple<int,int>>::iterator mit=obs.begin(), mend=obs.end(); mit!=mend; mit++)
    {
...
void MapPoint::PrintObservations()
{
    ...
    for(map<std::shared_ptr<KeyFrame>,tuple<int,int>>::iterator mit=mObservations.begin(), mend=mObservations.end(); mit!=mend; mit++)
    {
